...
the cost function, one gets the control law for $\underline{\tilde{\theta}}$:

$$ \underline{\dot{\tilde{\theta}}} = - \underline{\Gamma}_ \theta \underline{H}_ {\theta}^T \underline{\Gamma}_ e \underline{e} $$
